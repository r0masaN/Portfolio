...
## Основная информация
Данный репозиторий предназначен для хранения моего личного [портфолио](Портфолио.pdf) со списком всех моих проектов. Портфолио будет постоянно пополняться и обновляться.
